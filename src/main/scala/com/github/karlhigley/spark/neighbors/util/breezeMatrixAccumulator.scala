 ...
 * @author sramirez
 */
class breezeMatrixAccumulator(val rows: Int, val cols: Int) extends AccumulatorV2[Matrix[Float], Matrix[Float]] {
  ...
  def copy(): AccumulatorV2[Matrix[Float], Matrix[Float]] = new breezeMatrixAccumulator(accMatrix)
}